package com.biiway.stockassistant.components.loading
{
	...
	/**
	 * 继续<code>spark.components.BorderContainer</code>组件，增加加载提示功能
	 */
	public class LoadingBorderContainer extends BorderContainer
	{
		/**
		 * Loading组件
		 */
		...
		public function LoadingBorderContainer()
		{
			super();
		}
