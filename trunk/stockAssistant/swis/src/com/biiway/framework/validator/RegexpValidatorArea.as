...
//
////////////////////////////////////////////////////////////////////////////////
package com.biiway.framework.validator
{
	
	import com.biiway.framework.event.RegexpValidatorEvent;
	...
	[Event(name="validatorChange",type="com.biiway.framework.event.RegexpValidatorEvent")]

	/**
	 * 根据正则表则式对文本输入框进行验证
	 * 
	 * <p>
	 * 	扩展<code>spark.components.TextArea</code>类
	 * </p>
	 * 
	 * author： HUBO hubo.0508ⓐgmail.com
	 */
	public class RegexpValidatorArea extends TextArea
	{
		...
		private var _correctStyle:Class;
		
		private var _errorStyle:Class = IconUtil.textbox;
		
		/**
		 * 构造函数 
		 */	
		public function RegexpValidatorArea()
		{
			super();
		...
		private function validateHandler(event:Event = null):void
		{
			...
			if (validatorResult.type == ValidationResultEvent.VALID)
			{
				...
				//更改样式
				if(this.getStyle("borderSkin") as String != IconUtil.DEFAULT_INPUT_STYLE)
				{
					this.setStyle("borderSkin",this.correctStyle);
				}
			}
			else
			{
				...
				//更改样式
				if(this.getStyle("borderSkin") as String != IconUtil.VALIDATOR_INPUT_FAULT)
				{
					this.setStyle("borderSkin",this.errorStyle);
				}
		...
		public function get correctStyle():Class
		{
			return _correctStyle;
		}

		public function set correctStyle(value:Class):void
		{
			_correctStyle = value;
		}

		public function get errorStyle():Class
		{
			return _errorStyle;
		}

		public function set errorStyle(value:Class):void
		{
			_errorStyle = value;
		}
