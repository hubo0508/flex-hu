package org.hubo.flexextjs.components.dataGrid.renderer
{
	...
	import org.hubo.flexextjs.components.dataGrid.DataGridUtils;
	import org.hubo.flexextjs.event.DGCheckBoxColumnEvent;
	import org.hubo.flexextjs.ui.datagrid.DGCheckBoxColumn;
	import org.hubo.flexextjs.utils.ObjectUtils;

	[Event(name="columnClick",type="org.hubo.flexextjs.event.DGCheckBoxColumnEvent")]
	...
	public class CheckBoxItemRenderer extends CheckBox
	{
		...
		{
			this.dispatchEvent(new Event(DGCheckBoxColumn.CLICK_CHECKBOX_COLUMN,true));
		}
		...
		private function dispatchEventClick(dispatchFlag:Boolean):void
		{
			if(dispatchFlag)
			{
				var columenClickEvent:DGCheckBoxColumnEvent = new DGCheckBoxColumnEvent(DGCheckBoxColumnEvent.DG_CHECK_BOX_COLUMN,true);
				columenClickEvent.dgSelectedItem = this.selectItemsData;
				
				this.dispatchEvent(columenClickEvent);
			}
		}
